...
export const meta = () => {
  return baseMeta({
    ...
    description: `Portfolio of ${config.name} — a full-stack developer working on web apps with a focus on high-performance backend systems, AI integration, and beautiful user interfaces.`,
  });
};
